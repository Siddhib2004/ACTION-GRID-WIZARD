...
class FacultyLogin(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("GECCS Activity System - Faculty Login")
    ...
    def _build_ui(self):
        ...
        ctk.CTkLabel(header, text="Faculty Login", font=("Segoe UI", 28, "bold"),
    ...
    def authenticate(self):
        ...
        try:
            ...
            sql = """SELECT username FROM users 
                     ...
                     AND department=%s AND role='faculty'"""
    ...
    def back_to_main(self):
        self.destroy()
        messagebox.showinfo("Back", "Return to main menu (implement callback).")
